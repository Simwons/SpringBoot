...
import kr.co.sws.springbootSWS.config.jwt.JwtFactory;
import kr.co.sws.springbootSWS.config.jwt.JwtProperties;
import kr.co.sws.springbootSWS.domain.RefreshToken;
import kr.co.sws.springbootSWS.domain.User;
import kr.co.sws.springbootSWS.dto.CreateAccessTokenRequest;
...
class TokenApiControllerTest {
    ...
    @DisplayName("createNewAccessToken() : 새 액세스 토큰을 발급")
    @Test
